                ...
                <div id="descripcionServicio" class="row gx-5 justify-content-center align-items-center servicioHero">
                    <div class="col-lg-6">
                        <div class="text-center mb-5">
                            ...
                            <button class="btn btn-primary btnPersonal mt-5"><a href="#turnos">Pedir turno</a></button>
                        </div>
                    </div>
                    <div class="col-lg-6"><img class="img-fluid rounded-3 mb-5" src="<?php echo $contenido['imagen2'];?>" alt="..." /></div>
                </div>
            </div>
            <div class="row gx-5">
            </div>
                    ...
                    <div class="modal-content">
                        <form class="form-horizontal" method="POST" action="portfolio-item.php#turnos">
                            ...
                            <div class="modal-body">
                                <div class="col-sm-10">
                                    <?php
                                    if ($servicio == "extraccion" || $servicio == "ortodoncia" || $servicio == "blanqueamiento" || $servicio == "Fluor"){
        ...
        <section class="py-5">
                    <div class="container px-5">
                        <div id="descripcionServicio" class="row gx-5 justify-content-center align-items-center servicioHero">
                            ...
                            <div class="col-lg-6"><img class="img-fluid rounded-3 mb-5"src="<?php echo $contenido['imagen2'];?>" alt="..." />
                            </div>
                        </div>
                    </div>
                    <div class="modal-dialog" role="document">
